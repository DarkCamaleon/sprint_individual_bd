...
DROP DATABASE IF EXISTS sprint_final_individual_avenegas;

CREATE DATABASE sprint_final_individual_avenegas;

USE sprint_final_individual_avenegas;

DROP USER if exists 'avenegas'@'localhost';

CREATE USER 'avenegas'@'localhost' IDENTIFIED BY '1336677';

GRANT ALL PRIVILEGES ON sprint_final_individual_avenegas.* TO 'avenegas'@'localhost';
